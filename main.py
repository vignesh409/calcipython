...
class calculator:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='x', relief='flat', bg='white', command=lambda: self.show('*')).place(x=270,
                                                                                                              y=50)
        Button(width=11, height=4, text='=', relief='flat', bg='orange', command=self.slove).place(x=270, y=350)
        Button(width=11, height=4, text='C', relief='flat', bg='blue', command=self.clear).place(x=0, y=350)
